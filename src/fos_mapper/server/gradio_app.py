...
This script is used to create a gradio app for the SciNoBo FoS taxonomy mapper. It takes 
the input and calls the taxonomy mapper Fast API.
...
with gr.Blocks() as text_analysis:
    ...
    approach_input = gr.Textbox(label="Retrieval Approach", placeholder="Enter the approach for the retrieval (knn, elastic)")
    ...
    examples = gr.Examples(
        [
            ...
            [
                "1",
                "solar energy in renewable energy",
                "10",
                "knn"
            ],
            [
